...
export default class Lux {
   ...
   * @example
   * await lux.getWalletPublicKey("44'/9000'/0'/0/0");
   */
   ...
   * @example
   * await lux.getWalletExtendedPublicKey("44'/9000'/0'/0/0");
   */
   ...
   * @example
   * const signatures = await lux.signHash(
   ...
   * @example
   * const signatures = await lux.signTransaction(
   *   BIPPath.fromString("44'/9000'/0'"),
   *   [BIPPath.fromString("0/0")],
   *   Buffer.from("...", "hex"),
  ...
  /**
   * Get the version of the Lux app installed on the hardware device
   *
   ...
   * @example
   * console.log((await lux.getWalletId()).toString("hex"));
   *
   * 79c46bc3
   */
